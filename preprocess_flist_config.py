...
if __name__ == "__main__":
    ...
    parser.add_argument("--speech_encoder", type=str, default="mfcc", help="choice a speech encoder|'vec768l12','vec256l9','hubertsoft','whisper-ppg','cnhubertlarge','dphubert','whisper-ppg-large','wavlmbase+'")
    ...
    elif args.speech_encoder == "mfcc":
        config_template["model"]["ssl_dim"] = 32
        d_config_template["data"]["encoder_out_channels"] = 32
